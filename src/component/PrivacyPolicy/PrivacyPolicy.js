...
const PrivacyPolicy = () => {
  return (
    <section className="privacy_policy">
      <div className="privacy_policy__shadow-up"></div>
      <div className="privacy_policy__shadow-down"></div>
      <h1 className="privacy_policy__title">Privacy Policy</h1>
      <h2 className="privacy_policy__subtitle">
        1. Datenschutz auf einen Blick
      </h2>
      <h3 className="privacy_policy__subtitle_h3">Allgemeine Hinweise</h3>
      <p className="privacy_policy__text">
      ...
      <h3 className="privacy_policy__subtitle_h3">
        Datenerfassung auf dieser Website
      </h3>
      <h4 className="privacy_policy__subtitle_h4">
      ...
      <h2 className="privacy_policy__subtitle">2. Hosting</h2>
      <p className="privacy_policy__text">
        Wir hosten die Inhalte unserer Website bei folgendem Anbieter:
      </p>
      <h3 className="privacy_policy__subtitle_h3">Externes Hosting</h3>
      <p className="privacy_policy__text">
        ...
        auf diese Daten befolgen. Wir setzen folgende(n) Hoster ein: "OOO
        REG.RU".
      </p>
      ...
      <h3 className="privacy_policy__subtitle_h3">Datenschutz</h3>
      <p className="privacy_policy__text">
      ...
      <h3 className="privacy_policy__subtitle_h3">Speicherdauer</h3>
      <p className="privacy_policy__text">
      ...
      <p className="privacy_policy__text">
        ...
        oder in den Zugriff auf Informationen in Ihr Endgerät (z. B. via Device
      ...
      <h3 className="privacy_policy__subtitle_h3">Server-Log-Dateien</h3>
      <p className="privacy_policy__text">
        ...
        <br /> IP-Adresse
        <br />
        <br /> Eine Zusammenführung dieser Daten mit anderen Datenquellen wird
        nicht vorgenommen. Die Erfassung dieser Daten erfolgt auf Grundlage von
      ...
      <h2 className="privacy_policy__subtitle">5. Soziale Medien</h2>
      <h3 className="privacy_policy__subtitle_h3">Social-Media-Elemente</h3>
      <p className="privacy_policy__text">
        Auf dieser Website werden Elemente von einigen sozialen Medien
        verwendet. Die Social-Media Elemente können Sie in der Regel anhand der
        jeweiligen Social-Media-Logos erkennen. Sobald Sie das
        Social-Media-Element aktivieren, erhält der jeweilige Anbieter die
        Information, dass Sie mit Ihrer IP-Adresse diese Website besucht haben.
        Wenn Sie gleichzeitig in Ihrem jeweiligen Social-Media-Account
        eingeloggt sind, kann der jeweilige Anbieter den Besuch dieser Website
        Ihrem Benutzerkonto zuordnen. Das Aktivieren des Social-Media-Elements
        stellt eine Einwilligung im Sinne des Art. 6 Abs. 1 lit. a DSGVO und §
        25 Abs. 1 TTDSG dar. Diese Einwilligung können Sie jederzeit mit Wirkung
        ...
        Technologien einzuholen. Rechtsgrundlage hierfür ist Art. 6 Abs. 1 lit.
        c DSGVO.
      </p>
      <a
        href="https://www.e-recht24.de"
        target="_blank"
        className="privacy_policy__text privacy_policy__link"
      >
        <br />
...
/*
   <h1 className="privacy_policy__title">Privacy Policy</h1>
     <h2 className="privacy_policy__subtitle"></h2>
      <h3 className="privacy_policy__subtitle_h3"></h3>
<h4 className="privacy_policy__subtitle_h4"></h4>
       <p className="privacy_policy__text"></p>
       */
